...
<p> Given these 8 recorded trials, the false negative rate was 1/4. Judging from intuition though, I feel the rate was even lower among other sets of images I tried. Furthermore, with the mse threshold still at 60,000 for these 8 trials, the false positive rate was also 1/4.</p>
  ...
  },
  {
    ...
    subTitles: [
      {
        subTitleType: null,
        subTitle: "Web development is hard. Making your ideas into reality shouldn't be. I'm here to help."
      }
    ],
    description: `<div class="services-consulting services-flex square"><div class="services-flex-left consulting-border"><div class="size3">Consulting</div><div class="services-big-icon consulting-icon"></div></div><div class="services-sub-statement">Let’s start with the problem you’re facing. Now let’s solve it. My consulting process works backwards from the root cause of your needs, so that we can derive metric-driven solutions that build value.</div></div><div class="services-full-stack services-flex square"><div class="services-flex-left full-stack-border"><div class="size3">Full-Stack</div><div class="services-big-icon full-stack-icon"></div></div><div class="services-sub-statement">I’ve written all kinds of software, but specialize in JavaScript-driven web applications. With over six years of professional experience developing high-traffic consumer-facing products, I’m an expert at getting things to work.</div></div><div class="services-creative services-flex square"><div class="services-flex-left creative-border"><div class="size3">Creative</div><div class="services-big-icon creative-icon"></div></div><div class="services-sub-statement">Your online presence should reflect your passion. Let’s push the boundaries of what’s possible, and build a custom experience that shines.</div></div>`
  }
];
